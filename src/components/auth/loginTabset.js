                ...
                <Fragment>
                    <Tabs>
                        ...
                        <TabPanel>
                            <form className="form-horizontal auth-form">
                                <div className="form-group">
                                    <input required="" name="login[username]" type="email" className="form-control" placeholder="Email" id="exampleInputEmail12" />
                                </div>
                                <div className="form-group">
                                    <input required="" name="login[username]" type="text" className="form-control" placeholder="Address" id="exampleInputEmail12" />
                                </div>
                                <div className="form-group">
                                    <input required="" name="login[username]" type="text" className="form-control" placeholder="Country" id="exampleInputEmail12" />
                                </div>
                                <div className="form-group">
                                    <input required="" name="login[username]" type="number" className="form-control" placeholder="CNIC" id="exampleInputEmail12" />
                                </div>
                                <div className="form-group">
                                    <input required="" name="login[password]" type="password" className="form-control" placeholder="Password" />
                                </div>
